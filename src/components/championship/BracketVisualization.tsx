...
import { Trophy, Crown, Users, Grid3X3, Workflow } from "lucide-react";
import { Match } from "../../types";
import { AdvancedBracket } from "./AdvancedBracket";
...
export const BracketVisualization: React.FC<BracketVisualizationProps> = ({
  ...
  const BracketMatch: React.FC<{
    ...
    return (
      <Card
        className={`w-64 mb-2 cursor-pointer transition-all hover:shadow-md ${
          isSecondDivision ? "border-orange-300" : "border-blue-300"
        }`}
  ...
  const BracketRound: React.FC<{
    ...
    return (
      <div className="flex flex-col items-center min-h-full">
        <div
          className={`sticky top-0 z-10 mb-4 p-2 rounded-lg ${
            isSecondDivision
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex justify-between items-center">
        <h3 className="text-lg font-semibold">Visualização da Chave</h3>
      ...
      {viewMode === "advanced" ? (
        <AdvancedBracket onMatchClick={onMatchClick} />
      ) : (
